...
document.addEventListener('DOMContentLoaded', () => {
    ...
    setTimeout(() => {
        ...
        start.innerText = "Reaction Kinetic studies in a plug flow reactor";
        start.style.fontSize = "30px";
        start.classList.add("content-shine");
        start.style.left = "412px";
...
function setReactorTemp() {
    reactorVolume = document.getElementById("reactionTemp").value + " degree Celsius";
    document.getElementById('reactTemp').innerText = reactorVolume;
...
function rangeSlideEthyl() {
    acetConcen = document.getElementById('ethylVal').value;
...
function rangeSlideNaOH() {
    ohConcen = document.getElementById('naVal').value;
    document.getElementById('rangeValueNaOH').innerHTML = ohConcen + " M";
    document.getElementById('ohConc').innerHTML = ohConcen + " M";
